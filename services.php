...
<body>
    ...
    <nav class="navbar navbar-expand-lg py-5 border-bottom">
            <div class="container-xl">
                <a class="navbar-brand fw-bold logo" href="index.php">clemo.</a>
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                        <a class="nav-link fw-light menu-theme" href="#">services</a>
                        </li>
                        <li class="nav-item">
    ...
    <footer class="text-center text-black border-top">
